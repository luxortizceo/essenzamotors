...
const ESSENZA_UI = {
  ...
  'sell.consentimiento': { es: 'Acepto que ESSENZA MOTORS mx contacte mi información de acuerdo con el <a href="privacidad.html" target="_blank" rel="noopener">aviso de privacidad</a>.', en: 'I agree that ESSENZA MOTORS mx may use my information to contact me, per the <a href="privacidad.html" target="_blank" rel="noopener">privacy notice</a>.', de: 'Ich stimme zu, dass ESSENZA MOTORS mx meine Angaben gemäß der <a href="privacidad.html" target="_blank" rel="noopener">Datenschutzerklärung</a> zur Kontaktaufnahme nutzt.', fr: 'J’accepte qu’ESSENZA MOTORS mx utilise mes informations pour me contacter, conformément à l’<a href="privacidad.html" target="_blank" rel="noopener">avis de confidentialité</a>.', ru: 'Я согласен(на), что ESSENZA MOTORS mx свяжется со мной с использованием моих данных согласно <a href="privacidad.html" target="_blank" rel="noopener">политике конфиденциальности</a>.', it: 'Accetto che ESSENZA MOTORS mx utilizzi i miei dati per contattarmi, in conformità con l’<a href="privacidad.html" target="_blank" rel="noopener">informativa sulla privacy</a>.' },
  ...
  'sold.eyebrow': { es: 'Trayectoria', en: 'Track record', de: 'Verkaufshistorie', fr: 'Parcours', ru: 'История продаж', it: 'Percorso' },
  'sold.title': { es: 'Autos que ya encontraron nuevo dueño', en: 'Cars that already found a new owner', de: 'Fahrzeuge, die bereits einen neuen Besitzer gefunden haben', fr: 'Des voitures qui ont déjà trouvé un nouveau propriétaire', ru: 'Автомобили, которые уже нашли нового владельца', it: 'Auto che hanno già trovato un nuovo proprietario' },
  'sold.lead': { es: 'Una muestra de lo que ha pasado por el showroom ESSENZA. Si buscas algo similar, es probable que ya sepamos dónde encontrarlo.', en: 'A glimpse of what has passed through the ESSENZA showroom. Looking for something similar? We probably already know where to find it.', de: 'Ein Einblick, was bereits durch den ESSENZA-Showroom gegangen ist. Suchst du etwas Ähnliches? Wahrscheinlich wissen wir schon, wo wir es finden.', fr: 'Un aperçu de ce qui est déjà passé par le showroom ESSENZA. Vous cherchez quelque chose de similaire ? Nous savons probablement déjà où le trouver.', ru: 'Небольшой обзор того, что уже прошло через шоурум ESSENZA. Ищете что-то похожее? Мы, вероятно, уже знаем, где это найти.', it: 'Uno sguardo a ciò che è già passato dallo showroom ESSENZA. Cerchi qualcosa di simile? Probabilmente sappiamo già dove trovarlo.' },
  'sold.cta': { es: '¿Buscas algo similar? Escríbenos', en: 'Looking for something similar? Message us', de: 'Suchst du etwas Ähnliches? Schreib uns', fr: 'Vous cherchez quelque chose de similaire ? Écrivez-nous', ru: 'Ищете что-то похожее? Напишите нам', it: 'Cerchi qualcosa di simile? Scrivici' },
  'sold.badge': { es: 'Vendido', en: 'Sold', de: 'Verkauft', fr: 'Vendu', ru: 'Продано', it: 'Venduto' },
